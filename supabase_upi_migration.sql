-- =============================================================================
-- TEDxGCEM 2026: COMPLETE & DEFINITIVE MASTER DATABASE SCHEMA & MIGRATION
-- =============================================================================
...
--   2.  Special Guest Passes (Complimentary Passes with Resend & Admin Management)
...
-- =============================================================================
-- ⚡ QUICK RUN (For existing databases needing only the latest UPI Approvals + Guest Passes):
-- =============================================================================
/*
