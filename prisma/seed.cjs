...
const MEMBERS = [
  ...
  { slug: 'thanishasri-ss', name: 'Thanishasri', role: 'Creative Director', team: 'creative', oneLiner: 'Blending artistic vision with immersive multi-sensory audience touchpoints.', bio: 'Thanishasri directs creative direction, campaign artwork, and thematic storytelling assets.', contribution: 'Directing visual narrative, motion design direction, and promo campaign aesthetics.', interests: ['Creative Direction', 'Visual Arts', 'Motion Design'], photoUrl: '/members/placeholder.png' },
  ...
  { slug: 'vinayaka', name: 'Vinayaka V', role: 'Partnership Director', team: 'partnerships', oneLiner: 'Aligning corporate visionaries with the TEDx mission.', bio: 'As Partnership Director, I focus on building strategic alliances.', contribution: 'Established key corporate partnerships and sponsor booth installations.', interests: ['Partnerships', 'Financial Strategy', 'Negotiation'], photoUrl: '/VINAYAKA V.png', linkedin: 'https://www.linkedin.com/in/vinayaka464', email: 'vinayakavini464@gmail.com' },
