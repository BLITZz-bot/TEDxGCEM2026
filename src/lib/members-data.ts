...
export const INITIAL_MEMBERS: StaticMember[] = [
...

  {
    ...
    team: 'leadership',
    oneLiner: 'Steering TEDxGCEM vision, grand stage production, and designing the entire digital experience from code to stage.',
    ...
    interests: ['Software Engineer', 'Leadership', 'Strategic Vision', 'Graphic Designer'],
    photoUrl: '/BHARATH.png',
...

  {
    ...
    bio: 'Prof. Kartheek GCR is the Official TED Licensee and Organizer of TEDxGCEM 2026. He holds the official TED license, securing institutional approvals and steering the grand vision to bring world-class ideas to the GCEM stage.',
