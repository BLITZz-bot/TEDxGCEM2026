...
export default function Schedule() {
  ...
  return (
    <section className="min-h-screen pt-20 md:pt-32 pb-24 px-6 max-w-5xl mx-auto select-none bg-black text-white">
          ...
          {filteredSchedule.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative group border p-5 sm:p-6 flex flex-col gap-4 items-start justify-between cursor-pointer w-full [will-change:transform] schedule-card ${
                  isCardHovered 
                    ? "border-ted-red/40 bg-white/[0.02]" 
                    : "border-ted-red/40 md:border-white/10 md:hover:border-ted-red/40 bg-white/[0.01] hover:bg-white/[0.02]"
                }`}
                data-index={index}
              >
