  ...
  return (
    <section className="min-h-screen pt-32 pb-20 px-6 max-w-6xl mx-auto flex flex-col justify-center">
      ...
      >
        ...
        <h3 className="text-4xl md:text-6xl font-black italic tracking-tighter text-black">THE ROADMAP</h3>
      </motion.div>
              ...
              >
                ...
                <div className="w-full md:w-[45%]">
                  <motion.div
                    ...
                    className="bg-white border border-black/5 p-6 rounded-[2rem] cursor-pointer relative overflow-hidden transition-all duration-300 shadow-sm"
                  >
                    <div className="relative z-10 space-y-4">
                      <div className="flex justify-between items-center gap-2">
                        ...
                        <span className="text-[10px] uppercase font-mono tracking-widest text-black/30">
                          {item.location}
                        </span>
                      </div>

                      <h4 className={`text-xl font-bold tracking-tight ${
                        item.type === "break" ? "text-black/45" : "text-black"
                      }`}>
                        {item.event}
                      </h4>
                      ...
                      <AnimatePresence>
                        {isSelected && (
                          <motion.div
                            ...
                            className="pt-4 border-t border-black/5 flex flex-wrap gap-2 items-center"
                          >
                            <span className="text-[10px] text-black/40 font-bold uppercase tracking-wider font-mono flex items-center gap-1">
                              <Tag size={10} className="text-ted-red" />
                              Tags:
                            </span>
                            {item.tags.map(t => (
                              <span key={t} className="text-[9px] uppercase font-bold tracking-widest px-2 py-0.5 rounded-full bg-black/5 border border-black/10 text-black/50">
                                {t}
                              </span>
                            ))}
                          </motion.div>
                ...
                <div className="relative w-8 h-8 hidden md:flex items-center justify-center z-10">
                  <motion.div 
                    animate={{
                      ...
                      backgroundColor: isSelected ? "#EB0028" : "rgba(0, 0, 0, 0.1)",
