          ...
          >
            ...
            <div>
              ...
              <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed font-mono max-w-2xl">
                TEDxGCEM {getYear()} brings together thinkers, builders, and community pioneers under {settings?.reveal_theme && settings?.theme_name ? `the theme "${settings.theme_name}"` : "a theme that will be announced soon"}. On this single day, the campus main auditorium transforms into a launchpad for ideas that challenge the baseline of conventional frameworks and spark new connections.
              </p>
            </div>
