            ...
            {loading ? (
              ...
              >
                ...
                <div className="space-y-2 font-mono">
                  <h4 className="text-2xl font-black uppercase tracking-tight text-white">Join the Journey</h4>
                  <p className="text-white/50 text-sm leading-relaxed max-w-sm mx-auto font-sans font-light">
                    Have questions, partnership opportunities, speaker recommendations, or general inquiries? Connect with us and let&apos;s bring ideas worth spreading to life.
                  </p>
                </div>

                <button
                  onClick={loginWithGoogle}
                  className="group relative px-8 py-4 bg-white text-black font-black rounded-2xl text-xs hover:bg-ted-red hover:text-white transition-all duration-300 uppercase tracking-widest cursor-pointer shadow-lg animate-pulse"
                >
