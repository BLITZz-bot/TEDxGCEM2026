  ...
  return (
    <section className="min-h-screen pt-32 pb-20 px-6 max-w-6xl mx-auto flex flex-col">
      ...
      >
        ...
        <h3 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter text-black">CONTACT US</h3>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-grow">
        ...
        <motion.div
          ...
          className="bg-white border border-black/5 rounded-[2.5rem] p-8 md:p-10 flex flex-col h-full overflow-hidden shadow-sm"
        >
          <div className="mb-8">
            <h4 className="text-ted-red font-bold uppercase tracking-widest text-xs mb-4 font-mono">Location</h4>
            <p className="text-2xl font-black mb-2 text-black">GCEM Bengaluru</p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="mailto:organizer@tedxgcem.com" className="text-xl font-black hover:text-ted-red transition-colors text-black">organizer@tedxgcem.com</a>
              </div>
              <div>
                <h4 className="text-ted-red font-bold uppercase tracking-widest text-xs mb-1 font-mono">Phone</h4>
                <a href="tel:+917975871167" className="text-xl font-black hover:text-ted-red transition-colors text-black">+91 79758 71167</a>
              </div>
            </div>
          </div>

          {/* Map Container */}
          <div className="flex-grow relative rounded-[2rem] overflow-hidden border border-black/5 min-h-[300px] group">
            <iframe
              src={mapUrl}
        ...
        <motion.div
          ...
          className="bg-white border border-black/5 p-8 md:p-10 rounded-[2.5rem] flex flex-col h-full shadow-sm"
        >
          <div className="mb-8">
            <h4 className="text-2xl font-black mb-4 tracking-tight text-black">Send a Message</h4>
          ...
          <form className="space-y-4 flex-grow flex flex-col justify-between">
            <div className="space-y-4">
              <input 
                ...
                className="w-full bg-black/5 border border-black/5 rounded-2xl px-6 py-4.5 outline-none focus:border-ted-red transition-all text-sm text-black"
              />
              <input 
                type="email" 
              ...
              <textarea 
                ...
                className="w-full bg-black/5 border border-black/5 rounded-3xl px-6 py-4.5 outline-none focus:border-ted-red transition-all resize-none text-sm text-black"
              />
            </div>
            
            <button className="w-full py-5 mt-6 bg-black text-white font-black rounded-2xl hover:bg-ted-red hover:text-white transition-all uppercase tracking-widest text-sm shadow-sm border-none cursor-pointer">
              Send Message
            </button>
          </form>
        </motion.div>
