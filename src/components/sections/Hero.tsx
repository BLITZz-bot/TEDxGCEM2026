  ...
  return (
    <section className="min-h-screen relative flex flex-col justify-center px-6 md:px-20 overflow-hidden select-none bg-black">
      ...
      <motion.div
        ...
        className="relative z-10 max-w-xl flex flex-col items-start text-left space-y-6 md:translate-y-8"
      >
      ...
      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 md:left-20 md:translate-x-0 z-20 flex flex-col sm:flex-row items-center gap-4 w-full max-w-xs sm:max-w-md px-0 pointer-events-auto">
        <motion.button
